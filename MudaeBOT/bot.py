...
token = "" < #Insert Discord Token In Here
CHANNEL_ID =  # right click over the channel that has mudae, "Copy Channel ID"
desiredKakera = 300 #auto claim threshold, u can change this 
...
kakera_react_ready = False #leave as false
...
async def on_message(message):
    ...
    if message.channel.id == CHANNEL_ID and message.author != client.user:
        ...
        if "weebletmon" in message.content and "you __can__ claim right now" in message.content:
